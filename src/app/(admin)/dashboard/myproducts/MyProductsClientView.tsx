...
export default function MyProductsClientView({ products, total, currentPage }: { products: any[], total: number, currentPage: number }) {
  ...
  const setPage = (page: number) => {
    router.push(`/dashboard/myproducts?page=${page}`);
  };
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {products.length === 0 ? (
                <tr>
                  <td colSpan={6} className="text-center py-[100px] text-[#64748B]">
